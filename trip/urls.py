...
from .views import HomeView, trip_list, TripCreateView, TripDetailView, TripUpdateView, TripDeleteView,  NoteDetailView, NoteListView, NoteCreateView, NoteDeleteview, NoteUpdateView
